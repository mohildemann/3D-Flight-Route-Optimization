...
from ThreeDSpace import flight_Constraints
...
solution.placeholder_line = "example_route"
solution.PointFCName = "vergleich_least_cost_dp"
...
solution.placeholder_interpolated_surface = arcpy.env.workspace + "\\" + "threedpoints_1578154280__17_ph_ints"
...
arcpy.FeatureTo3DByAttribute_3d(r"D:\Master_Shareverzeichnis\1.Semester\Flighttaxi_project\MyProject15\MyProject15.gdb\Extract_vergleich_interpolated",
                                r"D:\Master_Shareverzeichnis\1.Semester\Flighttaxi_project\MyProject15\MyProject15.gdb\Extract_vergleich_interpolated_3d", "RASTERVALU")

solution.placeholder_representation = uls.point3d_fc_to_np_array(
    r"D:\Master_Shareverzeichnis\1.Semester\Flighttaxi_project\MyProject15\MyProject15.gdb\Extract_vergleich_interpolated_3d",
    additional_fields=["RASTERVALU", "noise"])



solution.fitness= problem_instance.fitness_function(problem_instance, solution)
